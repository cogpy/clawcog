# 🧠 OpenCog — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/cogpy/clawcog/main/docs/assets/opencog-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/cogpy/clawcog/main/docs/assets/opencog-logo-text.png" alt="OpenCog" width="500">
    </picture>
</p>

<p align="center">
  <strong>COGITATE! COGITATE!</strong>
</p>

<p align="center">
  <a href="https://github.com/cogpy/clawcog/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/cogpy/clawcog/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/cogpy/clawcog/releases"><img src="https://img.shields.io/github/v/release/cogpy/clawcog?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**OpenCog** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://opencog.ai) · [Docs](https://docs.opencog.ai) · [DeepWiki](https://deepwiki.com/cogpy/clawcog) · [Getting Started](https://docs.opencog.ai/start/getting-started) · [Updating](https://docs.opencog.ai/install/updating) · [Showcase](https://docs.opencog.ai/start/showcase) · [FAQ](https://docs.opencog.ai/start/faq) · [Wizard](https://docs.opencog.ai/start/wizard) · [Nix](https://github.com/cogpy/nix-opencog) · [Docker](https://docs.opencog.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`opencog onboard`) in your terminal.
The wizard guides you step by step through setting up the gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.opencog.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.opencog.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.opencog.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.opencog.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.opencog.ai/start/getting-started)

```bash
opencog onboard --install-daemon

opencog gateway --port 18789 --verbose

# Send a message
opencog message send --to +1234567890 --message "Hello from OpenCog"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
opencog agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.opencog.ai/install/updating) (and run `opencog doctor`).
...
Switch channels (git + npm): `opencog update --channel stable|beta|dev`.
Details: [Development channels](https://docs.opencog.ai/install/development-channels).
...
```bash
git clone https://github.com/cogpy/clawcog.git
cd clawcog
...
Note: `pnpm opencog ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `opencog` binary.

## Security defaults (DM access)

OpenCog connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.opencog.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `opencog pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `opencog doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.opencog.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.opencog.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.opencog.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.opencog.ai/nodes/voicewake) + [Talk Mode](https://docs.opencog.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.opencog.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.opencog.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.opencog.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.opencog.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.opencog.ai/nodes).
- **[Onboarding](https://docs.opencog.ai/start/wizard) + [skills](https://docs.opencog.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=cogpy/clawcog&type=date&legend=top-left)](https://www.star-history.com/#cogpy/clawcog&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.opencog.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.opencog.ai/web), and [Canvas host](https://docs.opencog.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.opencog.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.opencog.ai/start/wizard), and [doctor](https://docs.opencog.ai/gateway/doctor).
- [Pi agent runtime](https://docs.opencog.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.opencog.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.opencog.ai/concepts/groups).
- [Media pipeline](https://docs.opencog.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.opencog.ai/nodes/audio).

### Channels

- [Channels](https://docs.opencog.ai/channels): [WhatsApp](https://docs.opencog.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.opencog.ai/channels/telegram) (grammY), [Slack](https://docs.opencog.ai/channels/slack) (Bolt), [Discord](https://docs.opencog.ai/channels/discord) (discord.js), [Google Chat](https://docs.opencog.ai/channels/googlechat) (Chat API), [Signal](https://docs.opencog.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.opencog.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.opencog.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.opencog.ai/channels/msteams) (extension), [Matrix](https://docs.opencog.ai/channels/matrix) (extension), [Zalo](https://docs.opencog.ai/channels/zalo) (extension), [Zalo Personal](https://docs.opencog.ai/channels/zalouser) (extension), [WebChat](https://docs.opencog.ai/web/webchat).
- [Group routing](https://docs.opencog.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.opencog.ai/channels).

### Apps + nodes

- [macOS app](https://docs.opencog.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.opencog.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.opencog.ai/nodes/talk) overlay, [WebChat](https://docs.opencog.ai/web/webchat), debug tools, [remote gateway](https://docs.opencog.ai/gateway/remote) control.
- [iOS node](https://docs.opencog.ai/platforms/ios): [Canvas](https://docs.opencog.ai/platforms/mac/canvas), [Voice Wake](https://docs.opencog.ai/nodes/voicewake), [Talk Mode](https://docs.opencog.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.opencog.ai/platforms/android): [Canvas](https://docs.opencog.ai/platforms/mac/canvas), [Talk Mode](https://docs.opencog.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.opencog.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.opencog.ai/tools/browser): dedicated opencog Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.opencog.ai/platforms/mac/canvas): [A2UI](https://docs.opencog.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.opencog.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.opencog.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.opencog.ai/automation/cron-jobs); [webhooks](https://docs.opencog.ai/automation/webhook); [Gmail Pub/Sub](https://docs.opencog.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.opencog.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.opencog.ai/concepts/channel-routing), [retry policy](https://docs.opencog.ai/concepts/retry), and [streaming/chunking](https://docs.opencog.ai/concepts/streaming).
- [Presence](https://docs.opencog.ai/concepts/presence), [typing indicators](https://docs.opencog.ai/concepts/typing-indicators), and [usage tracking](https://docs.opencog.ai/concepts/usage-tracking).
- [Models](https://docs.opencog.ai/concepts/models), [model failover](https://docs.opencog.ai/concepts/model-failover), and [session pruning](https://docs.opencog.ai/concepts/session-pruning).
- [Security](https://docs.opencog.ai/gateway/security) and [troubleshooting](https://docs.opencog.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.opencog.ai/web) + [WebChat](https://docs.opencog.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.opencog.ai/gateway/tailscale) or [SSH tunnels](https://docs.opencog.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.opencog.ai/install/nix) for declarative config; [Docker](https://docs.opencog.ai/install/docker)-based installs.
- [Doctor](https://docs.opencog.ai/gateway/doctor) migrations, [logging](https://docs.opencog.ai/logging).
...
- **[Gateway WebSocket network](https://docs.opencog.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.opencog.ai/gateway)).
- **[Tailscale exposure](https://docs.opencog.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.opencog.ai/gateway/remote)).
- **[Browser control](https://docs.opencog.ai/tools/browser)** — opencog‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.opencog.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.opencog.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.opencog.ai/nodes/voicewake) + [Talk Mode](https://docs.opencog.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.opencog.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

OpenCog can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (OpenCog enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.opencog.ai/gateway/tailscale) · [Web surfaces](https://docs.opencog.ai/web)
...
Details: [Remote access](https://docs.opencog.ai/gateway/remote) · [Nodes](https://docs.opencog.ai/nodes) · [Security](https://docs.opencog.ai/gateway/security)
...
Details: [Nodes](https://docs.opencog.ai/nodes) · [macOS app](https://docs.opencog.ai/platforms/macos) · [Gateway protocol](https://docs.opencog.ai/concepts/architecture)
...
Details: [Session tools](https://docs.opencog.ai/concepts/session-tool)
...
- Controlled via `opencog nodes …`.

Runbook: [iOS connect](https://docs.opencog.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.opencog.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.opencog/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.opencog/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.cogpy/clawcog.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.opencog.ai/gateway/configuration)
...
Details: [Security guide](https://docs.opencog.ai/gateway/security) · [Docker + sandboxing](https://docs.opencog.ai/install/docker) · [Sandbox config](https://docs.opencog.ai/gateway/configuration)

### [WhatsApp](https://docs.opencog.ai/channels/whatsapp)

- Link the device: `pnpm opencog channels login` (stores creds in `~/.opencog/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.opencog.ai/channels/telegram)
...
### [Slack](https://docs.opencog.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.opencog.ai/channels/discord)
...
### [Signal](https://docs.opencog.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.opencog.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.opencog.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.opencog.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.opencog.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.opencog.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.opencog.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.opencog.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.opencog.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.opencog.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.opencog.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.opencog.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.opencog.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.opencog.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.opencog.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.opencog.ai/platforms/windows), [Linux](https://docs.opencog.ai/platforms/linux), [macOS](https://docs.opencog.ai/platforms/macos), [iOS](https://docs.opencog.ai/platforms/ios), [Android](https://docs.opencog.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.opencog.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.opencog.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.opencog.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.opencog.ai/gateway/bonjour)
- [Gateway pairing](https://docs.opencog.ai/gateway/pairing)
- [Remote gateway README](https://docs.opencog.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.opencog.ai/web/control-ui)
- [Dashboard](https://docs.opencog.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.opencog.ai/gateway/health)
- [Gateway lock](https://docs.opencog.ai/gateway/gateway-lock)
- [Background process](https://docs.opencog.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.opencog.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.opencog.ai/logging)

## Deep dives

- [Agent loop](https://docs.opencog.ai/concepts/agent-loop)
- [Presence](https://docs.opencog.ai/concepts/presence)
- [TypeBox schemas](https://docs.opencog.ai/concepts/typebox)
- [RPC adapters](https://docs.opencog.ai/reference/rpc)
- [Queue](https://docs.opencog.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.opencog.ai/tools/skills-config)
- [Default AGENTS](https://docs.opencog.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.opencog.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.opencog.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.opencog.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.opencog.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.opencog.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.opencog.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.opencog.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.opencog.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.opencog.ai/platforms/mac/voicewake)
- [iOS node](https://docs.opencog.ai/platforms/ios)
- [Android node](https://docs.opencog.ai/platforms/android)
- [Windows (WSL2)](https://docs.opencog.ai/platforms/windows)
- [Linux app](https://docs.opencog.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.opencog.ai/gmail-pubsub](https://docs.opencog.ai/automation/gmail-pubsub)

## Molty

OpenCog was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [opencog.ai](https://opencog.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@opencog](https://x.com/opencog)
...
<p align="left">
  ...
  <a href="https://github.com/ryancnelson"><img src="https://avatars.githubusercontent.com/u/347171?v=4&s=48" width="48" height="48" alt="ryancnelson" title="ryancnelson"/></a> <a href="https://github.com/search?q=Samrat%20Jha"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Samrat Jha" title="Samrat Jha"/></a> <a href="https://github.com/search?q=seans-opencogbot"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="seans-opencogbot" title="seans-opencogbot"/></a> <a href="https://github.com/senoldogann"><img src="https://avatars.githubusercontent.com/u/45736551?v=4&s=48" width="48" height="48" alt="senoldogann" title="senoldogann"/></a> <a href="https://github.com/Seredeep"><img src="https://avatars.githubusercontent.com/u/22802816?v=4&s=48" width="48" height="48" alt="Seredeep" title="Seredeep"/></a> <a href="https://github.com/sergical"><img src="https://avatars.githubusercontent.com/u/3760543?v=4&s=48" width="48" height="48" alt="sergical" title="sergical"/></a> <a href="https://github.com/search?q=shatner"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="shatner" title="shatner"/></a> <a href="https://github.com/shiv19"><img src="https://avatars.githubusercontent.com/u/9407019?v=4&s=48" width="48" height="48" alt="shiv19" title="shiv19"/></a> <a href="https://github.com/shiyuanhai"><img src="https://avatars.githubusercontent.com/u/1187370?v=4&s=48" width="48" height="48" alt="shiyuanhai" title="shiyuanhai"/></a> <a href="https://github.com/Shrinija17"><img src="https://avatars.githubusercontent.com/u/199155426?v=4&s=48" width="48" height="48" alt="Shrinija17" title="Shrinija17"/></a>
