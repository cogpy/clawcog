...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/opencog/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/opencog/extensions",
        global: "/Users/x/.opencog/extensions",
        workspace: "/Users/x/ws/.opencog/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.opencog/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/opencog/extensions",
        global: "/Users/x/.opencog/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.opencog/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/opencog/extensions",
        global: "/Users/x/.opencog/extensions",
