...
function resolveMentionPatterns(cfg: OpenCogConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenCogConfig | undefined, agentId?: string): RegExp[] {
