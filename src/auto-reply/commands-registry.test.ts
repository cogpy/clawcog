...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@opencog", { botUsername: "opencog" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@opencog args", {
        botUsername: "opencog",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "opencog" })).toBe(
      "/help@otherbot",
    );
  });
