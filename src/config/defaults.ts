...
function resolveAnthropicDefaultAuthMode(cfg: OpenCogConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyTalkApiKey(config: OpenCogConfig): OpenCogConfig {
...
export function applyModelDefaults(cfg: OpenCogConfig): OpenCogConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyLoggingDefaults(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyContextPruningDefaults(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyCompactionDefaults(cfg: OpenCogConfig): OpenCogConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
