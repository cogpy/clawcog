...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.OPENCOG_STATE_DIR;
  const configPath = env.OPENCOG_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    OPENCOG_PROFILE: profile,
    OPENCOG_STATE_DIR: stateDir,
    OPENCOG_CONFIG_PATH: configPath,
    OPENCOG_GATEWAY_PORT: String(port),
    OPENCOG_GATEWAY_TOKEN: token,
    OPENCOG_LAUNCHD_LABEL: resolvedLaunchdLabel,
    OPENCOG_SYSTEMD_UNIT: systemdUnit,
    OPENCOG_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    OPENCOG_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    OPENCOG_STATE_DIR: stateDir,
    OPENCOG_CONFIG_PATH: configPath,
    OPENCOG_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    OPENCOG_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    OPENCOG_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    OPENCOG_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    OPENCOG_LOG_PREFIX: "node",
    OPENCOG_SERVICE_MARKER: NODE_SERVICE_MARKER,
    OPENCOG_SERVICE_KIND: NODE_SERVICE_KIND,
    OPENCOG_SERVICE_VERSION: VERSION,
  };
}
