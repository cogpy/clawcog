...
export function listIMessageAccountIds(cfg: OpenCogConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: OpenCogConfig): string {
...
function mergeIMessageAccountConfig(cfg: OpenCogConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpenCogConfig): ResolvedIMessageAccount[] {
