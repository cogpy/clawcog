...
export type ChannelAgentToolFactory = (params: { cfg?: OpenCogConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenCogConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenCogConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenCogConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenCogConfig }) => boolean;
