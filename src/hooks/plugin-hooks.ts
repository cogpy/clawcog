...
import type { OpenCogPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpenCogPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpenCogPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
