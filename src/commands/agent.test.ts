...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "opencog-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpenCogConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpenCogConfig["telegram"]>>,
