...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.opencog.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("opencog hooks list")}`,
      `  ${formatCliCommand("opencog hooks enable <name>")}`,
      `  ${formatCliCommand("opencog hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
