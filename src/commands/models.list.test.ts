...
const ensureOpenCogModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveOpenCogAgentDir = vi.fn().mockReturnValue("/tmp/opencog-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/opencog-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureOpenCogModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveOpenCogAgentDir,
}));
