...
function resolveDefaultAccountId(cfg: OpenCogConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenCogConfig): boolean {
...
export function summarizeBindings(cfg: OpenCogConfig, bindings: AgentBinding[]): string[] {
