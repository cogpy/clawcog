...
function resolveConfiguredModelRaw(cfg: OpenCogConfig): string {
...
function resolveConfiguredModelKeys(cfg: OpenCogConfig): string[] {
...
export function applyPrimaryModel(cfg: OpenCogConfig, model: string): OpenCogConfig {
...
export function applyModelAllowlist(cfg: OpenCogConfig, models: string[]): OpenCogConfig {
  const defaults = cfg.agents?.defaults;
