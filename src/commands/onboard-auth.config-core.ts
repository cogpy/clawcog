...
export function applyZaiConfig(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyOpenrouterProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyOpenrouterConfig(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyMoonshotProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyMoonshotConfig(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyMoonshotConfigCn(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyKimiCodeProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenCogConfig): OpenCogConfig {
...
export function applySyntheticProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyXiaomiProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenCogConfig): OpenCogConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenCogConfig): OpenCogConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyXaiProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OpenCogConfig): OpenCogConfig {
...
export function applyQianfanProviderConfig(cfg: OpenCogConfig): OpenCogConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OpenCogConfig): OpenCogConfig {
