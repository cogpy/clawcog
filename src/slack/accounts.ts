...
export function listSlackAccountIds(cfg: OpenCogConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: OpenCogConfig): string {
...
function mergeSlackAccountConfig(cfg: OpenCogConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenCogConfig): ResolvedSlackAccount[] {
