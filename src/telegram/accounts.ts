...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OPENCOG_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: OpenCogConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OpenCogConfig): string {
...
function mergeTelegramAccountConfig(cfg: OpenCogConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: OpenCogConfig): ResolvedTelegramAccount[] {
