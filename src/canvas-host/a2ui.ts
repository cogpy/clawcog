...
export const A2UI_PATH = "/__opencog__/a2ui";

export const CANVAS_HOST_PATH = "/__opencog__/canvas";

export const CANVAS_WS_PATH = "/__opencog__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.opencogCanvasA2UIAction.postMessage(...)
  // - Android: window.opencogCanvasA2UIAction.postMessage(...)
  const handlerNames = ["opencogCanvasA2UIAction"];
  ...
  globalThis.OpenCog = globalThis.OpenCog ?? {};
  globalThis.OpenCog.postMessage = postToNode;
  globalThis.OpenCog.sendUserAction = sendUserAction;
  globalThis.opencogPostMessage = postToNode;
  globalThis.opencogSendUserAction = sendUserAction;
