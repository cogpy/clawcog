const DEFAULT_TAGLINE = "All your chats, one OpenCog.";
...
const TAGLINES: string[] = [
  "Your terminal just grew neurons—type something and let the bot process the busywork.",
  ...
  "Automation with brains: minimal fuss, maximal intelligence.",
  ...
  "Mind engaged, commit in—let's ship something mildly responsible.",
  "I'll butter your workflow like a cognitive boost: powerful, effective, brilliant.",
  "Shell yeah—I'm here to think through the toil and leave you the glory.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.OPENCOG_TAGLINE_INDEX;
