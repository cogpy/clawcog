...
export function listSignalAccountIds(cfg: OpenCogConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: OpenCogConfig): string {
...
function mergeSignalAccountConfig(cfg: OpenCogConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenCogConfig): ResolvedSignalAccount[] {
