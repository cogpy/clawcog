...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "opencog-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOpenCogPackageRoot } = await import("./opencog-root.js");
    ...
    vi.mocked(resolveOpenCogPackageRoot).mockResolvedValue("/opt/opencog");
