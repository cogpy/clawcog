...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OpenCogConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OpenCogConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OpenCogConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: OpenCogConfig): void {
