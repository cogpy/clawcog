...
import { type OpenCogConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenCogConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenCogConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenCogConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenCogConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: OpenCogConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: OpenCogConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OpenCogConfig): GatewaySessionsDefaults {
