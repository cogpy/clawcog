...
function resolveAvatarSource(cfg: OpenCogConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenCogConfig, agentId: string): AgentAvatarResolution {
