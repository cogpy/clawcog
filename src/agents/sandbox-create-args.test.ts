  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "opencog.sandbox=1",
        "--label",
        "opencog.sessionKey=main",
        "--label",
        "opencog.createdAtMs=1700000000000",
        "--label",
        "opencog.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
