...
describe("createOpenCogCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOpenCogCodingTools({
      config,
    ...
    const anthropicTools = createOpenCogCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpenCogCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpenCogCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
