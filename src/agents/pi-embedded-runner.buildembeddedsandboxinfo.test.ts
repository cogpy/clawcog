...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies OpenCogConfig;

const _ensureModels = (cfg: OpenCogConfig, agentDir: string) =>
  ensureOpenCogModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/opencog-sandbox",
      agentWorkspaceDir: "/tmp/opencog-workspace",
      ...
      browser: {
        ...
        containerName: "opencog-sbx-browser-test",
      },
