...
export const DEFAULT_SANDBOX_IMAGE = "opencog-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "opencog-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "opencog-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "opencog-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "opencog-sbx-browser-";
