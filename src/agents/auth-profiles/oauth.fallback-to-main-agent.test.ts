...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenCogAgentDir() returns mainAgentDir
    process.env.OPENCOG_STATE_DIR = tmpDir;
    process.env.OPENCOG_AGENT_DIR = mainAgentDir;
