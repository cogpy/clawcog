...
// pi-ai's built-in Anthropic catalog can lag behind OpenCog's defaults/docs.
...
export function buildModelAliasLines(cfg?: OpenCogConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveOpenCogAgentDir();
