...
import { resolveOpenCogDocsPath } from "../docs-path.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  const agentDir = params.agentDir ?? resolveOpenCogAgentDir();
  await ensureOpenCogModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createOpenCogCodingTools({
      exec: {
    ...
    const docsPath = await resolveOpenCogDocsPath({
      workspaceDir: effectiveWorkspace,
