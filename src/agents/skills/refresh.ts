...
function resolveWatchPaths(workspaceDir: string, config?: OpenCogConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenCogConfig }) {
