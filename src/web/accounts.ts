...
function listConfiguredAccountIds(cfg: OpenCogConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: OpenCogConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenCogConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OpenCogConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OpenCogConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenCogConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenCogConfig): ResolvedWhatsAppAccount[] {
