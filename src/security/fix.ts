...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OpenCogConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OpenCogConfig; env: NodeJS.ProcessEnv }): {
  cfg: OpenCogConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
