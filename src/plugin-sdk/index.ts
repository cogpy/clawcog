...
export type { OpenCogConfig } from "../config/config.js";
/** @deprecated Use OpenCogConfig instead */
export type { OpenCogConfig as ClawdbotConfig } from "../config/config.js";
