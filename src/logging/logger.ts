...
export const DEFAULT_LOG_DIR = "/tmp/opencog";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "opencog.log"); // legacy single-file path

const LOG_PREFIX = "opencog";
...
function resolveSettings(): ResolvedSettings {
  let cfg: OpenCogConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => OpenCogConfig;
      };
