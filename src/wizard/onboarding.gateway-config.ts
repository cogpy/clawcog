...
import type { GatewayBindMode, GatewayTailscaleMode, OpenCogConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.opencog.ai/gateway/tailscale", "https://docs.opencog.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
