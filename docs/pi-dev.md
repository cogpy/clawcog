...
This guide summarizes a sane workflow for working on the pi integration in OpenCog.
...
- Trigger the agent directly:
  - `pnpm opencog agent --message "Hello" --thinking low`
...
State lives under the OpenCog state directory. Default is `~/.opencog`. If `OPENCOG_STATE_DIR` is set, use that directory instead.

To reset everything:

- `opencog.json` for config
...
- [https://docs.opencog.ai/testing](https://docs.opencog.ai/testing)
- [https://docs.opencog.ai/start/getting-started](https://docs.opencog.ai/start/getting-started)
