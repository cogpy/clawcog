---
summary: "First-run onboarding flow for OpenCog (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenCog">
...
<Step title="CLI">
  ...
  The app can install the global `opencog` CLI via npm/pnpm so terminal
