...
- Install via CLI: `opencog plugins install @opencog/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `opencog plugins install ./extensions/zalo`
   - From npm (if published): `opencog plugins install @opencog/zalo`
...
- Approve via:
  - `opencog pairing list zalo`
  - `opencog pairing approve zalo <CODE>`
...
- Example: `opencog message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `opencog channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `opencog logs --follow`
