...
read_when:
  - You are building a OpenCog plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (opencog.plugin.json)

Every plugin **must** ship a `opencog.plugin.json` file in the **plugin root**.
OpenCog uses this manifest to validate configuration **without executing plugin
