...
本指南总结了在 OpenCog 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenCog 状态目录下。默认为 `~/.opencog`。如果设置了 `OPENCOG_STATE_DIR`，则使用该目录。
...
- https://docs.opencog.ai/testing
- https://docs.opencog.ai/start/getting-started
