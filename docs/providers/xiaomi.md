---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenCog"
read_when:
  - You want Xiaomi MiMo models in OpenCog
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenCog uses
