...
You can point OpenCog at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenCog
...
- [Anthropic provider](/providers/anthropic) - Native OpenCog integration with Claude setup-token or API keys
