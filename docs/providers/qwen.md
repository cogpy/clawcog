---
summary: "Use Qwen OAuth (free tier) in OpenCog"
read_when:
  - You want to use Qwen with OpenCog
...
If you already logged in with the Qwen Code CLI, OpenCog will sync credentials
