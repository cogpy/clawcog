---
summary: "Use Qianfan's unified API to access many models in OpenCog"
read_when:
...
3. OpenCog installed on your system
...
4. Copy the API key for use with OpenCog

## CLI setup

```bash
opencog onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenCog Configuration](/gateway/configuration)
