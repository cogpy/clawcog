...
- Same path: run the app from a fixed location (for OpenCog, `dist/OpenCog.app`).
...
Workaround: move files into the OpenCog workspace (`~/.opencog/workspace`) if you want to avoid per-folder grants.
