...
OpenCog treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.opencog/settings/voicewake.json`

Shape:

```json
{ "triggers": ["opencog", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
