...
OpenCog has two separate “streaming” layers:
...
When block streaming is enabled, OpenCog can **merge consecutive block chunks**
...
When draft streaming is active, OpenCog disables block streaming for that reply to avoid double-streaming.
