...
export function listGoogleChatAccountIds(cfg: OpenCogConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenCogConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenCogConfig): ResolvedGoogleChatAccount[] {
