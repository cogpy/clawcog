...
- Version alignment with core OpenCog release numbers.
...
- First public release of the @opencog/voice-call plugin.
...
- CLI: `opencog voicecall` commands (call/start/continue/speak/end/status/tail/expose).
