...
export function listZalouserAccountIds(cfg: OpenCogConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenCogConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenCogConfig, accountId: string): ZalouserAccountConfig {
