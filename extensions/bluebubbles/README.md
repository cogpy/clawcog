...
This directory contains the **BlueBubbles external channel plugin** for OpenCog.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `opencog/plugin-sdk` helpers.
