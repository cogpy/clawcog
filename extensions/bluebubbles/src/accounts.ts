...
export function listBlueBubblesAccountIds(cfg: OpenCogConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpenCogConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpenCogConfig): ResolvedBlueBubblesAccount[] {
