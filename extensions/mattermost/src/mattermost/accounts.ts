...
export function listMattermostAccountIds(cfg: OpenCogConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenCogConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenCogConfig): ResolvedMattermostAccount[] {
