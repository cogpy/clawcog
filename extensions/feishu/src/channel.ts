import type { ChannelMeta, ChannelPlugin, ClawdbotConfig } from "opencog/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "opencog/plugin-sdk";
