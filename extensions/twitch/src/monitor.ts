...
import type { ReplyPayload, OpenCogConfig } from "opencog/plugin-sdk";
import { createReplyPrefixOptions } from "opencog/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OpenCogConfig;
