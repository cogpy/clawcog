...
show_usage() {
    cat << EOF
clawlog - OpenCog Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View OpenCog logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    OpenCog logs flow through the macOS unified log (subsystem: ai.opencog).
