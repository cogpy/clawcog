...
# Output:
# - dist/OpenCog.app
# - dist/OpenCog-<version>.zip
# - dist/OpenCog-<version>.dmg
...
ZIP="$ROOT_DIR/dist/OpenCog-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenCog-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenCog-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenCog-$VERSION.dSYM.zip"
