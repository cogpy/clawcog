...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.opencog.gateway"
    private static let nodeService = "ai.opencog.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.opencog.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.opencog.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("opencog-gateway.log")
    }
