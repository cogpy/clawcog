...
final class ScreenController {
    ...
    /// Callback invoked when an opencog:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = OpenCogKitResources.bundle
...
/// Handles navigation policy to intercept opencog:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept opencog:// deep links.
        if url.scheme?.lowercased() == "opencog" {
