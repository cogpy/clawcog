...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OpenCogPhotosLatestParams) async throws -> OpenCogPhotosLatestPayload {
        ...
        var results: [OpenCogPhotoPayload] = []
        ...
        return OpenCogPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OpenCogPhotoPayload
    {
