...
@MainActor
public struct OpenCogChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: OpenCogChatViewModel
    ...
    public init(
        viewModel: OpenCogChatViewModel,
    ...
    private var visibleMessages: [OpenCogChatMessage] {
        let base: [OpenCogChatMessage]
    ...
    private func mergeToolResults(in messages: [OpenCogChatMessage]) -> [OpenCogChatMessage] {
    ...
    private func isToolResultMessage(_ message: OpenCogChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OpenCogChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OpenCogChatMessage) -> String {
