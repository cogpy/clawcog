...
public typealias OpenCogPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpenCogPlatformImage = UIImage
#endif

public struct OpenCogChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpenCogChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpenCogChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpenCogChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpenCogChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpenCogChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpenCogChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpenCogChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpenCogChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpenCogChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpenCogChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpenCogChatMessageContent].self, forKey: .content) {
...
public struct OpenCogChatHistoryPayload: Codable, Sendable {
...
public struct OpenCogSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpenCogSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpenCogSessionPreviewItem]
}

public struct OpenCogSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpenCogSessionPreviewEntry]

    public init(ts: Int, previews: [OpenCogSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpenCogChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpenCogChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpenCogAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpenCogChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpenCogGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpenCogPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpenCogPlatformImage?
...
public struct OpenCogChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
