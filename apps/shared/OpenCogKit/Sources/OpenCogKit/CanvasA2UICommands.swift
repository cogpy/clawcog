...
public enum OpenCogCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpenCogCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpenCogCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
