...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.opencog", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.opencog", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OpenCogProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
