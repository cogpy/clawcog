...
public enum OpenCogTalkCommand: String, Codable, Sendable {
...
public struct OpenCogTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpenCogTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
