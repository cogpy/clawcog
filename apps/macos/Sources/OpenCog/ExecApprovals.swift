...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.opencog", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        OpenCogPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        OpenCogPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
