...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.opencog", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenCog windows, but below the system’s pop-up menus.
