...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.opencog", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OpenCog/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__opencog__/a2ui/").absoluteString + "?platform=macos"
    }
