...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.opencog", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenCogConfigFile.defaultWorkspaceURL() }
