...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.opencog", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".opencog/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.opencogCommand(
            subcommand: "gateway",
