...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .opencogSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenCogPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenCogPaths.stateDirURL.path
...
extension Notification.Name {
    static let opencogSelectSettingsTab = Notification.Name("opencogSelectSettingsTab")
}
