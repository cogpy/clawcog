...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/opencog/opencog") {
            ...
            VStack(alignment: .center, spacing: 6) {
                ...
                AboutLinkRow(icon: "globe", title: "Website", url: "https://opencog.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "OpenCogBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "OpenCogBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenCogGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenCogGitCommit") as? String) ??
            "unknown"
    }
