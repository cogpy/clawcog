...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenCog"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OpenCogOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OpenCogChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g opencog@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenCogChatViewModel(
