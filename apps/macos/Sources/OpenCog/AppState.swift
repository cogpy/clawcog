...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenCogConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenCogConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OpenCogConfigFile.loadDict()
            ...
            OpenCogConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/opencog"
        state.remoteCliPath = ""
        return state
    }
}
